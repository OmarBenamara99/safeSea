...
public class DriverLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(DriverLoginActivity.this , R.color.textDescription));
                ...
                fAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()){
                            Toast.makeText(DriverLoginActivity.this, "Connecté avec succès", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(getApplicationContext(), DriverMapActivity.class));
                            progressBar.setVisibility(View.GONE);
                            finish();
                        }
                        else {
                            Toast.makeText(DriverLoginActivity.this, "Erreur !" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                            progressBar.setVisibility(View.GONE);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        fAuth.sendPasswordResetEmail(mail).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void unused) {
                                Toast.makeText(DriverLoginActivity.this, "Lien de réinitialisation envoyé à votre adresse e-mail", Toast.LENGTH_SHORT).show();

                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(DriverLoginActivity.this, "Erreur ! Le lien de réinitialisation n'est pas envoyé" + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
